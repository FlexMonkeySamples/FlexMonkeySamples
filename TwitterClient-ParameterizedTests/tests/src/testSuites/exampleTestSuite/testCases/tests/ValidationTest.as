package testSuites.exampleTestSuite.testCases.tests {
	...
	public class ValidationTest extends FlexMonkeyFlexUnit4Base implements IFlexMonkeyTest {
		...
		[Test(async, timeout=5000, order=3)]
		...
		[Test(async, timeout=10000, order=4)]
		public function validationTest4():void {
			runFlexMonkeyCommand(new VerifyGridMonkeyCommand('New Verify Grid', 'myDg', 'automationName', 0, 0, 'KEY: _TwitterClient_Label1Key', null, null, true, '1000', '10'));
		}
